...
export default function Mp4ToWav() {
  ...
  const convert = async () => {
    ...
    try {
      await getFFmpeg();
      setProgress("Extracting WAV audio from video...");
      ...
      a.href = url;
      a.download = file.name.replace(/\.mp4$/i, "") + ".wav";
      a.click();
  ...
  return (
    <div className="tool-container">
      <div className="text-center mb-10">
        <h1 className="page-title">MP4 to WAV</h1>
        <p className="page-desc mt-3">
          Extract high quality WAV audio from MP4 video files. Lossless audio
          extraction in your browser.
        </p>
      </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {done ? (
            <div className="success-msg">
              <p>WAV audio extracted and downloaded!</p>
            </div>
          ) : (
            <div className="text-center">
              ...
              >
                {converting ? "Extracting Audio..." : "Extract WAV Audio"}
              </button>
            </div>
          )}
        </div>
